...
const ServiceCategoryForm = () => {
  ...
  const addHandler = (e)=>{
    ...
    multiInstance.post('service-category', data).then(()=>{
  ...
  const updHandler = (e)=>{
    ...
    multiInstance.patch(`service-category/${selectedCategory?.id}`, data).then(()=>{
  ...
  const deleteHandler = (e)=>{
    e.preventDefault()
    multiInstance.delete(`service-category/${selectedCategory?.id}`).then(()=>{
